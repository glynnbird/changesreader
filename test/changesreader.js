...
describe('ChangesReader', function () {
  ...
  describe('polling', function () {
    it('one poll no changes', function (done) {
      ...
      nock(SERVER)
        .get(changeURL)
        .query({ feed: 'longpoll', timeout: 60000, since: 'now', limit: 100, seq_interval: 100, include_docs: false })
    ...
    it('multiple polls', function (done) {
      ...
      nock(SERVER)
        ...
        .reply(200, { results: [], last_seq: '1-0', pending: 0 })
        .get(changeURL)
        .query({ feed: 'longpoll', timeout: 60000, since: '1-0', limit: 100, seq_interval: 100, include_docs: false })
        .reply(200, { results: [], last_seq: '1-0', pending: 0 })
        .get(changeURL)
        .query({ feed: 'longpoll', timeout: 60000, since: '1-0', limit: 100, seq_interval: 100, include_docs: false })
  ...
  describe('parameters', function () {
    it('batchSize', function (done) {
      ...
      nock(SERVER)
        .get(changeURL)
        .query({ feed: 'longpoll', timeout: 60000, since: 'now', limit: limit, seq_interval: limit, include_docs: false })
        .reply(200, { results: [], last_seq: '1-0', pending: 0 })
        .get(changeURL)
        .delay(2000)
        .reply(500)
    ...
    it('since', function (done) {
      ...
      nock(SERVER)
        .get(changeURL)
        .query({ feed: 'longpoll', timeout: 60000, since: since, limit: limit, seq_interval: limit, include_docs: false })
        .reply(200, { results: [], last_seq: '1-0', pending: 0 })
        .get(changeURL)
        .delay(2000)
        .reply(500)
  ...
  describe('stopOnEmptyChanges', function () {
    it('stop on no changes', function (done) {
      ...
      nock(SERVER)
        .get(changeURL)
        .query({ feed: 'longpoll', timeout: 60000, since: since, limit: batchSize, seq_interval: batchSize, include_docs: false })
        .reply(200, { results: [], last_seq: '1-0', pending: 0 })
        .get(changeURL)
        .delay(2000)
        .reply(500)
    ...
    it('stop after multiple batches - small batch stop', function (done) {
      ...
      nock(SERVER)
        ...
        .get(changeURL)
        .query({ feed: 'longpoll', timeout: 60000, since: '45-0', limit: batchSize, seq_interval: batchSize, include_docs: false })
    ...
    it('stop after multiple batches - zero stop', function (done) {
      ...
      nock(SERVER)
        ...
        .get(changeURL)
        .query({ feed: 'longpoll', timeout: 60000, since: '90-0', limit: batchSize, seq_interval: batchSize, include_docs: false })
  ...
  describe('errors', function () {
    ...
    it('on bad since value', function (done) {
      ...
      nock(SERVER)
        .get(changeURL)
        .query({ feed: 'longpoll', timeout: 60000, since: 'badtoken', limit: 100, seq_interval: 100, include_docs: false })
